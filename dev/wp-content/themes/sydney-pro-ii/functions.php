...
define( 'ATHEMES_THEME_NAME', 'Sydney Pro' );
...
//Instantiate
$this_theme = wp_get_theme('sydney-pro-ii');
$license = trim( get_option( 'sydneyii_license_key' ) );
$edd_updater = new EDD_Theme_Updater( array(
	'remote_api_url' 	=> ATHEMES_STORE_URL,
	'version' 	 		=> $this_theme->get( 'Version' ),
	'license' 	 		=> $license,
	'item_name' 	 	=> ATHEMES_THEME_NAME,
	'author'	 		=> 'aThemes',
	'url'            	=> home_url()
) );

require get_template_directory() . '/inc/updates-admin.php';

/**
 * License notice
 */
function sydneyii_admin_notice(){

	$license = get_option( 'sydneyii_license_key' );

	if (!$license) {
	    echo '<div class="updated">';
	    echo 	'<p>Please activate your license key for Sydney Pro to get the latest theme updates automatically. You can get your key from your <a href="http://athemes.com/your-account/" target="_blank">aThemes account</a> and activate it <a href="' . menu_page_url( 'sydneyii_license' ,0 ) . '">here</a></p>';
	    echo '</div>';
	}
}
add_action('admin_notices', 'sydneyii_admin_notice');