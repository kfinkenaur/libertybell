...
class maxButtonsPlugin
{
	...
	*/
	...
	{
		$version = MAXBUTTONS_VERSION_NUM;
		wp_register_script('maxbuttons-modal', $this->plugin_url . 'js/maxmodal.js', array('jquery','jquery-ui-draggable'), $version, true); 
	...
	*/
	function media_button($editor_id) {
		...
		wp_enqueue_script('mb-media-button', $this->plugin_url . 'js/maxbuttons_media_button.js', array('jquery', 'maxbuttons-modal'), $version, true); 
		$this->load_modal_script();
