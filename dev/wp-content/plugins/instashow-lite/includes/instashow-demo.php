<div class="instashow-demo">
    <form class="instashow-demo-form">
        <input class="instashow-demo-form-client-id" type="hidden" name="clientId" value="<?php echo $client_id; ?>">
            ...
            <div class="instashow-admin-accordion-item active">
                ...
                <div class="instashow-admin-accordion-item-content">
                    <div class="instashow-demo-source instashow-demo-field-group">
                        <div class="instashow-demo-field-group-name"><?php _e('Instagram source', INSTASHOW_LITE_TEXTDOMAIN); ?></div>

                        <div class="instashow-demo-field-group-description">
                            <?php _e('Specify one of 3 available source options: @username, #hashtag or a single Instagram photo URL. Want more? For infinte combinations of these sources check out the Pro Version.', INSTASHOW_LITE_TEXTDOMAIN); ?>
                        </div>

                        <div class="instashow-demo-field">
                            <input type="text" class="instashow-demo-text-input" name="source" placeholder="<?php _e('add a source', INSTASHOW_LITE_TEXTDOMAIN); ?>">
                        </div>
                    </div>
            ...
            <div class="instashow-admin-accordion-item">
                ...
                <div class="instashow-admin-accordion-item-content">
                    ...
                    <div class="instashow-demo-field-group">
                        ...
                        <div class="instashow-demo-rows instashow-demo-field-disabled instashow-demo-field">
                            <img src="<?php echo plugins_url('assets/img/pro-option-disabled-rows.jpg', INSTASHOW_LITE_FILE); ?>">
