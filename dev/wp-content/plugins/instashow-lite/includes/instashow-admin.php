...
function instashow_lite_update_instagram_connect() {
    ...
    update_option('instashow_instagram_client_id', !empty($_REQUEST['client_id']) ? $_REQUEST['client_id'] : '');
...
function instashow_lite_settings_page() {
    ...
    $client_id = get_option('instashow_instagram_client_id', '');
    ...
    ?><div class="instashow-admin wrap">
        ...
        <div class="instashow-admin-instagram-connect<?php echo $client_id || $access_token ? ' instashow-admin-instagram-connected' : ''?> instashow-admin-block">
            ...
            <div class="instashow-admin-block-inner">
                <h2><?php _e('Connect to Instagram API', INSTASHOW_LITE_TEXTDOMAIN); ?></h2>
                ...
                <div class="instashow-admin-instagram-connect-access-token">
                    <div class="instashow-admin-instagram-connect-access-token-text">
                        ...
                        <?php if (!$access_token) {?>
                            <p><?php _e('You can authorize in Instagram and Access Token will be recieved automatically.', INSTASHOW_LITE_TEXTDOMAIN); ?></p>
                ...
                <div class="instashow-admin-instagram-connect-divider"><?php _e('or', INSTASHOW_LITE_TEXTDOMAIN); ?></div>

                <div class="instashow-admin-instagram-connect-client-id">
                    <div class="instashow-admin-instagram-connect-client-id-text">
                        <h3><?php _e('Instagram Client ID', INSTASHOW_LITE_TEXTDOMAIN); ?> <span><?php _e('(deprecated)', INSTASHOW_LITE_TEXTDOMAIN); ?></span></h3>
                        <p><?php printf(__('Instagram Client ID is deprecated since the 17th November 2015. If you used it before please renew your authorization with Instagram Access Token. <a href="%s" target="_blank">Learn more</a>', INSTASHOW_LITE_TEXTDOMAIN), 'https://elfsight.com/blog/2015/11/no-more-need-in-instagram-client-id-after-november-17-2015/'); ?></p>
                    </div>

                    <form data-nonce="<?php echo wp_create_nonce('instashow_lite_update_instagram_connect_nonce'); ?>">
                        <input type="text" placeholder="<?php _e('Instagram Client ID', INSTASHOW_LITE_TEXTDOMAIN); ?>" name="instashow_instagram_client_id" value="<?php echo esc_attr(get_option('instashow_instagram_client_id')); ?>" class="regular-text" spellcheck="false" autocomplete="off">
                        <input type="hidden" name="instashow_instagram_access_token" value="<?php echo $access_token; ?>">
                    </form>
                </div>
            </div>
        </div>
