...
Description: A simple wordpress customizable responsive slideshow with box navigation
Version: 1.4
	...
	class JTC_Slides
	{
		...
		function jtcslideshow_func( $atts ) {
			...
			<div id="jtcSlideShowWrapper'.$termID.'">
				...
				<style scoped>
					#jtcSlideShowWrapper'.$termID.' {position:relative;width:100%;display:table;max-width:'.$jtcSlideShowMaxWidth.'px;max-height:'.$jtcSlideShowMaxHeight.'px;background:#'.$bgcolor.';}
					...
					#jtcSlideShowWrapper'.$termID.' .jtcSlide img {max-width: 100%;}
				...
				if($jtcSlideShowAuto == "on"){
						...
						function changeJtcSlide'.$termID.'() {
						 ...
						 function adjustWrapperHeight'.$termID.'(){
	 						...
	 						var newWrapperWidth = Math.floor(wrapperWidth*slideShowRatio);
	 						jQuery("#jtcSlideShowWrapper'.$termID.'").height((newWrapperWidth) + "px");
	 						jQuery("#jtcSlideShowWrapper'.$termID.' .jtcSlides").height((newWrapperWidth) + "px");
	 						jQuery("#jtcSlideShowWrapper'.$termID.' .jtcSlides .jtcSlidesInner").height((newWrapperWidth) + "px");
	 					}
