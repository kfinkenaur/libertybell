...
To activate slideshow mode set the “GSS Slideshow” option to “Yes” when editing a gallery in the WordPress media manager. (“GSS Slideshow” option requires version 1.3.2+; see legacy instructions below for GSS versions prior to 1.3.2.) Alternatively you can manually add the “gss” option to a Wordpress gallery shortcode:

`[gallery gss=“1” columns="3" ids="1,2,3"]`
...
`[gallery gss="1" ids="1,2,3" options="timeout=4000" name="myslideshow" style="width:50%" carousel="fx=carousel"]`
...
**Legacy GSS Shortcode Instructions** (GSS versions prior to 1.3.2)
...
To make changes to your slideshow change the shortcode back to "gallery" (in "Text" mode) and make edits using the visual editor / media manager. Optional shortcode attributes are supported.
...
1. The WordPress Media Manager showing the “GSS Slideshow” option under the “Gallery Settings” sidebar at right. “GSS Slideshow” option requires version 1.3.2+.
...
3. The "Edit Page" admin screen showing the WP editor in text mode and a sample “gss” legacy shortcode.
...
= 1.1 =
Plugin now supports custom options via inclusions of optional 'gss-custom.js' file.