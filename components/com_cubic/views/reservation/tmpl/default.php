...
#TellUsReplaceArea{display: block;}
#TellUsArea{display: none !important;}
.my_move_plan_area{display: none !important;}
...
jQuery(function(){ // on DOM load
    ...
    $menuRight = jQuery('.pushmenu-right');
    $nav_list = jQuery('.sideviewtoggle1');
    $nav_list_right = jQuery('.sideviewtoggle2');
    
    $nav_list.click(function() {
      jQuery(this).toggleClass('active');
      jQuery('.pushmenu-push').toggleClass('pushmenu-push-toright');
      jQuery('.pushmenu-left').toggleClass('pushmenu-open');
    });
    $nav_list_right.click(function() {
      jQuery(this).toggleClass('active');
      jQuery('.pushmenu-push').toggleClass('pushmenu-push-toleft');
      jQuery('.pushmenu-right').toggleClass('pushmenu-open');
    });
});
