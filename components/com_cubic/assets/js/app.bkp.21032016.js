var myApp = angular.module('myApp',['ngCart','ngAnimate','ui.router']);
...
myApp.controller ('myCtrl', ['$scope', '$http', 'ngCart', function($scope, $http, ngCart) {
    ...
    $scope.addCustomItem = function() {
        ...
        ngCart.addItem($scope.custom_item_id, $scope.custom_item_name, $scope.custom_item_price, $scope.custom_item_weight, $scope.custom_item_size, 1, $scope.filters.category, 1);
    ...
    $scope.submitPlan = function() {
        if($scope.formData.cur_user_login > 0){
          ...
          review_html_data1 = review_html_data1.replace('Your move is not booked yet!', 'This move is booked!');
          ...
          review_html_data2 = review_html_data2.replace('Your move is not booked yet!', 'Your move is booked!');
          review_html_data2 = review_html_data2.replace('Log in and complete your booking to lock in your price.', '');
          review_html_data2 = review_html_data2.replace('Reserve your move! Your move is not booked yet.', 'Your move is Reserved now');
