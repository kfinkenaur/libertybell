...
if (!JFactory::getUser()->authorise('core.edit.state', 'com_cubic'))
{
		...
		foreach($items as $item){
			...
			if (isset($item->category)) {
				...
				foreach ($values as $value){
					if(!empty($value)){
						$db = JFactory::getDbo();
						$query = "select id,cat_name from #__cubic_categories";
						$db->setQuery($query);
	...
	protected function loadFormData()
	{
		...
		if ($error_dateformat)
		{
			$app->enqueueMessage(JText::_("COM_CUBIC_SEARCH_FILTER_DATE_FORMAT"), "warning");
