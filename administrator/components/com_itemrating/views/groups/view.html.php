 ...
 */
class ItemratingViewGroups extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		ItemratingBackendHelper::addSubmenu('groups');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_ITEMRATING_TITLE_GROUPS'), 'groups.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_itemrating&view=groups');
	...
	protected function getSortFields()
	{
		...
		'a.checked_out' => JText::_('COM_ITEMRATING_GROUPS_CHECKED_OUT'),
		'a.checked_out_time' => JText::_('COM_ITEMRATING_GROUPS_CHECKED_OUT_TIME'),
		'a.created_by' => JText::_('COM_ITEMRATING_GROUPS_CREATED_BY'),
		'a.title' => JText::_('COM_ITEMRATING_GROUPS_TITLE'),
		);
	}
