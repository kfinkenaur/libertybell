 ...
 * View to edit
 */
class ItemratingViewGroup extends JViewLegacy
{
	protected $state;
	protected $item;
	protected $form;
	...
	protected function addToolbar()
	{
		...
		$canDo		= ItemratingBackendHelper::getActions();

		JToolBarHelper::title(JText::_('COM_ITEMRATING_TITLE_GROUP'), 'group.png');
