...
class MCAPI {
    ...
    * @param array $content the content for this campaign - use a struct with the following keys: 
                ...
                "archive" to send a  encoded archive file for us to import all media from. Note, this will override any other content options - for lists with Email Format options, you'll need to turn on generate_text as well
