...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_cubic&task=categoriess.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_cubic&view=categoriess'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<?php echo JHtml::_('grid.sort', 'JSTATUS', 'a.`state`', $listDirn, $listOrder); ?>
					...
					<?php endif; ?>
									...
									<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_CUBIC_CATEGORIESS_CAT_NAME', 'a.`cat_name`', $listDirn, $listOrder); ?>
				</th>
...
<th class='left'>
				...
				<?php foreach ($this->items as $i => $item) :
					...
					<tr class="row<?php echo $i % 2; ?>">
						...
						<?php if (isset($this->items[0]->state)): ?>
							<td class="center">
	<?php echo JHtml::_('jgrid.published', $item->state, $i, 'categoriess.', $canChange, 'cb'); ?>
</td>
						<?php endif; ?>

										<td>
				<?php if (isset($item->checked_out) && $item->checked_out) : ?>
					<?php echo JHtml::_('jgrid.checkedout', $i, $item->editor, $item->checked_out_time, 'categoriess.', $canCheckin); ?>
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_cubic&task=categories.edit&id='.(int) $item->id); ?>">
				...
				<td>
				<a href="<?php echo JUri::root().'components/com_cubic/assets/'.$item->thumb; ?>" class="modal"><img width="100" height="100" src="<?php echo JUri::root().'components/com_cubic/assets/'.$item->thumb; ?>" /></a>
									</td>
