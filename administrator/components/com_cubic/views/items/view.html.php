 ...
 */
class CubicViewItems extends JViewLegacy {
    ...
    protected function addToolbar() {
        ...
        JHtmlSidebar::setAction('index.php?option=com_cubic&view=items');
	...
	protected function getSortFields()
	{
		...
		'a.`item_name`' => JText::_('COM_CUBIC_ITEMS_ITEM_NAME'),
		'a.`category`' => JText::_('COM_CUBIC_ITEMS_CATEGORY'),
		'a.`thumb`' => JText::_('COM_CUBIC_ITEMS_THUMB'),
		'a.`cost`' => JText::_('COM_CUBIC_ITEMS_COST'),
		'a.`item_size`' => JText::_('COM_CUBIC_ITEMS_ITEM_SIZE'),
		'a.`uid`' => JText::_('COM_CUBIC_ITEMS_UID'),
		);
	}
