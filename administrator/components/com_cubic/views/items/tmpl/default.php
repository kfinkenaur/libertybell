...
<form action="<?php echo JRoute::_('index.php?option=com_cubic&view=items'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<?php echo JHtml::_('grid.sort', 'JSTATUS', 'a.`state`', $listDirn, $listOrder); ?>
				...
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_CUBIC_ITEMS_ITEM_WEIGHT', 'a.`item_weight`', $listDirn, $listOrder); ?>
				</th>				
				<th class='left'>
	...
	<?php echo JHtml::_('jgrid.published', $item->state, $i, 'items.', $canChange, 'cb'); ?>
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_cubic&task=item.edit&id='.(int) $item->id); ?>">
				...
				<!-- <a href="../<?php echo $item->thumb; ?>" class="modal"><img width="100" height="100" src="../<?php echo $item->thumb; ?>" /></a> -->
									</td>
				<td>
