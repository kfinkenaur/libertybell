...
Donate link: http://www.happytables.com
Tags: yelp, qype, urbanspoon, places, rating, ratings, review, reviews, restaurant, restaurants, pub, tavern, cafe, hospitality, social media
Version: 1.3.0
...
* See it in action on our [Pubforce Theme](http://pubforce.happytables.com/).
...
* Want to see our website solutions for restaurants? Check out [happytables](http://www.happytables.com)!
* Want to stay up-to-date with restaurant, pub or cafe news relevant to WordPress?  [Follow me on Twitter](http://www.twitter.com/noeltock)
...
1. Go to the options panel under the 'Settings' menu and add your API data and other settings.
1. Don't forget to rate if you like or dislike it!
...
1. Screenshot of Website Display (as you can see, theme design is irrelevant)
2. Screenshot of Setting & API status
