...
function sydney_custom_styles($custom) {
    ...
    if ( class_exists('WooCommerce') && is_woocommerce() ) {
		$custom .= ".content-area {float:right;}"."\n"; 
		$custom .= "#secondary {float:left;}"."\n"; 	
    }
