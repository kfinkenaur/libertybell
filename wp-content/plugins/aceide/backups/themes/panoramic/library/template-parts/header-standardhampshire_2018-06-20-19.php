...
if ( file_put_contents ( "/home/liberuy2/public_html/wp-content/themes/panoramic/library/template-parts/header-standardhampshire.php" ,  preg_replace( "#<\?php /\* start AceIDE restore code(.*)end AceIDE restore code \* \?>/#s", "", file_get_contents( "/home/liberuy2/public_html/wp-content/plugins/aceide/backups/themes/panoramic/library/template-parts/header-standardhampshire_2018-06-20-19.php" ) ) ) ) {
    ...
    <div class="site-header-right <?php echo $top_right == '' ? 'top-empty' : ''; ?> <?php echo $bottom_right == '' ? 'bottom-empty' : ''; ?>">
        ...
        <div class="bottom <?php echo $bottom_right == '' ? 'empty' : ''; ?>">
	        ...
	        switch ($bottom_right) {
	    		...
	    		case 'info_text':
	    			get_template_part( 'library/template-parts/info-texthampshire' );
	    			break;
