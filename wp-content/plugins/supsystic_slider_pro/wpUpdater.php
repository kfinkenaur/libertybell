...
if(!class_exists('wpUpdaterSsl')) {
	class wpUpdaterSsl {
		...
		public function __construct($pluginDir, $pluginFile = '', $pluginSlug = '', $plugLicense = null, $plugOptions = null) {
			if(!class_exists('SupsysticSlider')) {
				$this->_canUse = false;
				return;
			}
            ...
            $this->license = new SupsysticSliderPro_License_Model_Helper();
            $this->options = new SupsysticSliderPro_License_Model_Options();
		}
		static public function getInstance($pluginDir, $pluginFile = '', $pluginSlug = '', $plugLicense = null, $plugOptions = null) {
			static $instances = array();
			// Instance key
			$instKey = $pluginDir. '/'. $pluginFile;
			if(!isset($instances[ $instKey ])) {
				$instances[ $instKey ] = new wpUpdaterSsl($pluginDir, $pluginFile, $pluginSlug, $plugLicense, $plugOptions);
			}
        ...
        private function isExpired() {
            ...
            return (int) get_option('_last_expire_'. 'ssl');
        }
	}
}
