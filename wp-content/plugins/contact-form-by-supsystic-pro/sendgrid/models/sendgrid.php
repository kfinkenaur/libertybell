<?php
class sendgridModelCfs extends modelSubscribeCfs {
	...
	public function getLists() {
		...
		if($listsRes && is_array($listsRes) && !empty($listsRes['lists'])) {
			...
			$this->pushError(__('You have no lists. Login to your SendGrid account and create your first list before start using this functionality.', CFS_LANG_CODE));
