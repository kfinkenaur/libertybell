  ...
  <div id="wp-map-main">
    ...
    <div id="submitdiv" class="map-col map-col-rt">
      <div class="map-parameters">
        ...
        <div class="map-box-body">
          ...
          <div class="map-field"><span class="map-parameter icon-lakes">Lakes Fill</span><input type="text" name="lake_fill" value="<?php echo $wp_map['lake_fill']; ?>" class="color-field" /></div>
          <div class="map-field"><span class="map-parameter icon-lakes-out">Lakes Outline</span><input type="text" name="lake_outline" value="<?php echo $wp_map['lake_outline']; ?>" class="color-field" /></div>
        </div><!-- map-box-body -->
      </div><!-- map-parameters -->
      <p class="color-hint"><strong>Hint:</strong> you can set any color as transparent to hide the object.</p>
    </div><!-- map-col-rt -->
    ...
    <script>
      function apostSolution() {
          window.open("<?php echo WPMMAP_URL . 'templates/apostrophe.html'; ?>", "", "width=600, height=230");
      }
    </script>
