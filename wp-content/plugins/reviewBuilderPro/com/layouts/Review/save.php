...
<!-- Comment form edit -->
					...
					<div class="sg-box sgrb-comment-form-box">
						<div class="sg-box-title"><?php echo _e('Comment form options', 'sgrb');?></div>
						<div class="sg-box-content">
