...
class SGRB_Comment_RatingModel extends SGRB_Model
{
	...
	public static function create()
	{
		...
		$categoryTable = SGRB_CategoryModel::TABLE;
		$commentTable = SGRB_CommentModel::TABLE;
		$categoryTable = $wpdb->dbname.'.'.$wpdb->prefix.$sgrb->prefix.$categoryTable;
		$commentTable = $wpdb->dbname.'.'.$wpdb->prefix.$sgrb->prefix.$commentTable;
