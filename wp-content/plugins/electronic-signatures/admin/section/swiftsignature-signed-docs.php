                ...
                <tbody>
                    <?php if (count($fLog)): ?>
                        <?php foreach ($fLog as $log): ?>
                            <tr>
                                <td><a href="https://swiftcloud.io/form/signatures/signed-docs" target="_blank"><?php echo (!empty($log->ssign_capture_name) ? $log->ssign_capture_name : "Name Not Given"); ?></a></td>
                                <td><a href="https://swiftcloud.io/form/signatures/signed-docs" target="_blank"><?php echo $log->ssign_capture_email; ?></a></td>
                                <td><a href="https://swiftcloud.io/form/signatures/signed-docs" target="_blank"><time class="timeago" datetime="<?php echo $log->date_time; ?>"><?php echo $log->date_time; ?></time></a></td>
                                    ...
                                    foreach ($captured_data as $hv_key => $hv_val) {
                                        ...
                                        if (!empty($hv_val)) {
                                            if (stripos($hv_key, "ss_signDataURL") !== false) {
                                                ...
                                                $op .= '<img src="data:image/png;base64,' . $code_base64 . '" style="vertical-align: middle;" />';
