...
function panoramic_customizer_library_build_styles() {
	global $mobile_menu_breakpoint, $solid_nav_menu_breakpoint;
	...
	if ( get_theme_mod( 'panoramic-mobile-menu', customizer_library_get_default( 'panoramic-mobile-menu' ) ) ) {
		if ( wp_is_mobile() && get_theme_mod( 'panoramic-mobile-menu-activate-on-mobile', customizer_library_get_default( 'panoramic-mobile-menu-activate-on-mobile' ) ) ) {
			...
			if ( $mobile_menu_breakpoint > $solid_nav_menu_breakpoint ) {
				$solid_nav_menu_breakpoint = floatVal( get_theme_mod( 'panoramic-mobile-menu-breakpoint', customizer_library_get_default( 'panoramic-mobile-menu-breakpoint' ) ) );
			}
		}
	}

    // Page Content Background Color
    $color = 'panoramic-page-content-background-color';
    ...
    if ( $colormod !== customizer_library_get_default( $color ) ) {
        ...
        Customizer_Library_Styles()->add( array(
        	...
        	'media' => '(max-width: ' .$solid_nav_menu_breakpoint. 'px)'
        ) );
    ...
    // Primary Color & navigation opacity
    $color = 'panoramic-primary-color';
    $colormod = get_theme_mod( $color, customizer_library_get_default( $color ) );
    
    $opacity = 'panoramic-layout-navigation-opacity';
    ...
    if ( $colormod !== customizer_library_get_default( $color ) || $opacitymod !== customizer_library_get_default( $opacity ) ) {
		...
		Customizer_Library_Styles()->add( array(
	    	...
	    	'declarations' => array(
	    		'background-color' => 'rgba(' .$sancolor_rgb['r']. ',' .$sancolor_rgb['g']. ',' .$sancolor_rgb['b']. ', '. $opacitymod .')'
	    	)
		) );
    }
    ...
    $color = 'panoramic-mobile-menu-button-color';
    $colormod = get_theme_mod( $color, customizer_library_get_default( $color ) );
    ...
    $fontweight = get_theme_mod( 'panoramic-body-font-weight', customizer_library_get_default( 'panoramic-body-font-weight' ) );
    ...
    // Body Font Weight
    $fontweight = 'panoramic-body-font-weight';
    ...
    $color = 'panoramic-layout-zebra-stripe-even-color';
    $colormod = get_theme_mod( $color, customizer_library_get_default( $color ) );
    ...
    // Slider text overlay background color and button rollover color and opacity
	$color 	 = 'panoramic-slider-text-overlay-background-color';
	$opacity = 'panoramic-slider-text-overlay-opacity';
    ...
    // Header Image text overlay background color and opacity
    $color 	 = 'panoramic-header-image-text-overlay-background-color';
    $opacity = 'panoramic-header-image-text-overlay-opacity';
