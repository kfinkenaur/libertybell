...
<li id="<?php echo $post->post_name; ?>-section" class="<?php echo ( get_theme_mod( 'panoramic-layout-zebra-stripe', customizer_library_get_default( 'panoramic-layout-zebra-stripe' ) ) && ($pageCount+1) % 2 == 0 ) ? 'even' : ''; ?>">
	<div class="container">
		...
		<?php
		if ( get_theme_mod( 'panoramic-layout-first-page-title', customizer_library_get_default( 'panoramic-layout-first-page-title' ) ) && get_theme_mod( 'panoramic-layout-display-page-titles', customizer_library_get_default( 'panoramic-layout-display-page-titles' ) ) && pageCount == 0 ) {
			the_title( '<h1 class="entry-title">', '</h1>' );
		} else if ( get_theme_mod( 'panoramic-layout-display-page-titles', customizer_library_get_default( 'panoramic-layout-display-page-titles' ) ) && $pageCount > 0 ) {
