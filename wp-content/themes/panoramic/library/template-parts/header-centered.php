...
<nav id="site-navigation" class="main-navigation border-bottom <?php echo ( $is_translucent ) ? 'translucent' : ''; ?> <?php echo esc_attr( ( get_theme_mod( 'panoramic-animated-submenus', customizer_library_get_default( 'panoramic-animated-submenus' ) ) ) ? 'animated-submenus' : '' ); ?>" role="navigation">
