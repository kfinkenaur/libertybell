...
// https://stackoverflow.com/questions/783818/how-do-i-create-a-custom-error-in-javascript
    ...
    var Webcam = {
        ...
        params: {
            ...
            flashNotDetectedText: 'ERROR: No Adobe Flash Player detected. Swift Signature Webcam relies on Flash for browsers that do not support getUserMedia (like yours).',
            ...
            if (this.hooks[name] && this.hooks[name].length) {
                ...
                if ((args[0] instanceof FlashError) || (args[0] instanceof WebcamError)) {
                    ...
                    message = "Could not access webcam";
                            //args[0].name + ": " + args[0].message + " " + args[0].toString();
                }

                // default error handler if no custom one specified
//                alert("Swift Signature Error: " + message);
                jQuery('.swiftsign-webcam-container').html(message);
            }
        ...
        getSWFHTML: function() {
            ...
            if (location.protocol.match(/file/)) {
                ...
                return '<h3 style="color:red">ERROR: the Swift Signature Error Flash fallback does not work from local disk.  Please run it from a web server.</h3>';
            }
