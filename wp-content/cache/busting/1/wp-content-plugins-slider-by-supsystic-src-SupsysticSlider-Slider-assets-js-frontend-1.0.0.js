	...
	function correctImageSocialButtons($imageSharing) {
		...
		$imageSharing.find('.social-sharing-button.mail').on('click',function(){
			var $infoElement = $(this).closest('.supsystic-grid-gallery-image-sharing'),
				...
				url = window.location.href.replace(window.location.hash,'') + '#' + image_id + '/',
				src = 'mailto:adresse@example.com?subject=' + encodeURIComponent(document.title) + ',' + image_title + '&body=' + url,
