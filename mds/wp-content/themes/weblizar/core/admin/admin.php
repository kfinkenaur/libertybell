<?php
/***** Theme Info Page *****/
if (!function_exists('weblizar_info_page')) {
	function weblizar_info_page() {
	$page1 = add_theme_page(__('Welcome to Weblizar', 'weblizar'), __('Theme Info', 'weblizar'), 'edit_theme_options', 'enigma', 'weblizar_theme_info_page');
...
function weblizar_admin_info(){
	wp_enqueue_style('admin-css',  get_template_directory_uri() .'/core/admin/admin.css');
	
}
if (!function_exists('weblizar_theme_info_page')) {
	function weblizar_theme_info_page() {
		...
		<div class="theme-info-wrap">
			...
			<div class="theme-links clearfix">
				<p><strong><?php _e('Important Links:', 'weblizar'); ?></strong>
					...
					<a href="https://wordpress.org/support/theme/weblizar" target="_blank"><?php _e('Support Center', 'weblizar'); ?></a>
					<a href="https://wordpress.org/support/view/theme-reviews/weblizar?filter=5" target="_blank"><?php _e('Rate this theme', 'weblizar'); ?></a>
				</p>
			</div>
			<hr>
				...
				<div class="row clearfix">
					<div class="col-1-2">
						...
						<div class="section">
							...
							<p>
								<a href="https://weblizar.com/themes/weblizar-premium-theme/" target="_blank" class="button button-secondary"><?php _e('Learn more about the Premium Version', 'weblizar'); ?></a>
							</p>
						</div>
					</div>
					<div class="col-1-2">
			...
			<div id="theme-author">
				<p><?php printf(__('%1s is proudly brought to you by %2s. If you like this WordPress theme, %3s.', 'weblizar'),
					...
					'<a target="_blank" href="https://wordpress.org/support/view/theme-reviews/weblizar?filter=5" title="Weblizar Review">' . __('rate it', 'weblizar') . '</a>'); ?>
				</p>
			</div>
		</div>		
		<?php
