...
function wdwt_plugins_description($slug){
	...
	switch ($slug) {
		...
		case 'spider-event-calendar':
			...
			break;
		case 'wd-google-maps':
			$string = 'Google Maps WD is a user-friendly, responsive Google maps plugin. It is very simple in use and does not require any coding skills or complex customizations.' ;
			break;
